export const CONCERTS = [
    ...
    },
    {
        ...
        source:
            "https://www.facebook.com/cabrochicoband/posts/pfbid02iNUfmDsXtVPiKEWJAx4x66DPDcVz3Meg8VB4jZk9TqzPnam8n5srhr3KA6B1MfPGl",
    },
    {
        date: "2023-05-06",
        place: "Pico Bistrot",
        ...
        source:
            "https://www.facebook.com/cabrochicoband/posts/pfbid03zT1XU1UN4yE4y5JSBQPQtaSnc4nhQH3hgDjHvmA9sA6TT3JU77kMopCgza8tsifl",
    },
    {
        date: "2023-04-13",
        place: "Radio Campus",
        city: "Lille",
        source:
            "https://www.facebook.com/cabrochicoband/posts/pfbid0w6rANgXx2ZFy5tQcCqAhKuPxKDVoevWYLXhVJt8D92D7ZGKJPZAiWEv8LK8baa1dl",
    },
    {
        date: "2022-12-10",
        ...
        bands: ["Victor", "Utopie"],
        source:
            "https://www.facebook.com/cabrochicoband/posts/pfbid0fNHdMV3s43jPiL5wcq1s9hU76bBs3gQUuW8gQKbKSP1TogcEDDFkfxGnjdRTbQqvl",
    },
    {
        date: "2022-11-26",
    ...
    },
    {
        ...
        source:
            "https://www.facebook.com/events/s/festival-de-cinema-colombia-mi/696951285807323/",
    },
    {
        date: "2022-11-12",
    ...
    },
    {
        ...
        place: "Tattoo Hippie Club",
        city: "Dunkerque",
        bands: ["Misskeen", "The Gash", "Mingawash"],
    },
    {
        date: "2023-10-28",
        place: "Arena Bar",
...
const NOW = new Date();
export const FUTURE_CONCERTS = CONCERTS.filter(
    ({ date }) => new Date(Date.parse(date)) > NOW
);

export const PAST_CONCERTS = CONCERTS.filter(
    ({ date }) => new Date(Date.parse(date)) < NOW
);
